...
if ($jwt === null) {
    ...
    if ($statuse === 'pengeluaran') {
        $query = "UPDATE t_outcome SET c_nominal = :nominal, c_detail = :detail, c_datetime = :timen WHERE id = :id";
    } else {
        $query = "UPDATE t_income SET c_nominal = :nominal, c_detail = :detail, c_datetime = :timen WHERE id = :id";
    }
